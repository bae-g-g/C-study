...
> 이전 학습: [03. 에디터](../00_개발_환경과_빌드%28심화%29/03_에디터.md)
> 다음 학습: [02. 정수 실수 문자](./02_정수_실수_문자.md)

<p align="center">
  <img src="./img/t.png" alt="01. 자료형 대표 이미지" width="720">
</p>

### 학습 목표

- 자료형의 핵심 개념과 사용 목적을 설명할 수 있다.
- 예제 코드를 읽고 실행 흐름과 결과를 단계별로 추적할 수 있다.
- 이전 단원에서 배운 개념과 다음 단원에서 이어질 내용을 연결할 수 있다.

### 수업 흐름

1. C Language Learning Road Map
2. Data Type 자료형
3. Terminology 용어
4. Little & Big Endian 선언 및 초기화 방식
...
- 예: 게임에서 캐릭터가 공격받아 -1레벨이 되었는데 +최고 레벨업하는 경우가 생김
...
- 이유: Window OS 처리 기반에서 처리 및 효율성 증가 고려
...
- 이유: Mac OS 처리 기반에서 처리 및 효율성 증가 고려
...
---
<!-- LESSON-NAV:START -->
[이전: 03. 에디터](../00_개발_환경과_빌드%28심화%29/03_에디터.md) · [단원 목차](./README.md) · [다음: 02. 정수 실수 문자](./02_정수_실수_문자.md)
<!-- LESSON-NAV:END -->

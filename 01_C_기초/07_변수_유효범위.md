...
> 이전 학습: [06. 실수 표현](./06_실수_표현.md)  
> 다음 학습: [보조. 배열 예비 노트](./array.md)

### 학습 목표

- 변수 유효범위의 핵심 개념과 사용 목적을 설명할 수 있다.
...
## **static +**
- 참고: static Global Variable 전역변수 & Static Variable 정적변수는 특정값 초기화하지 않으면 0 초기화
...
- 참고: static Global Variable 전역변수 & Static Variable 정적변수는 Compiling 동안 "한번만" 초기화
...
- 참고: 정적변수 자료형 O ≠ 정적변수 자료형 X: 자료형 상이
- 따라서 초기화 X
...
- 참고: 정적변수 자료형 Compling Time(exe File 생성)시 1회 초기화 O
- 사용자정의 함수의 매개변수에 초기화되는 시점은 Run Time(exe File 실행)시
- 따라서 사용자정의 함수의 매개변수가 정적변수 자료형 O → 초기화 X
...
---
<!-- LESSON-NAV:START -->
[이전: 06. 실수 표현](./06_실수_표현.md) · [단원 목차](./README.md) · [다음: 보조. 배열 예비 노트](./array.md)
<!-- LESSON-NAV:END -->

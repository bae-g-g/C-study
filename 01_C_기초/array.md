...
> 이전 학습: [07. 변수 유효범위](./07_변수_유효범위.md)  
> 다음 학습: [01. 기본 입출력](../02_입출력_및_연산자/01_기본_입출력.md)

<p align="center">
  <img src="./img/a1.png" alt="보조. 배열 예비 노트 대표 이미지" width="720">
</p>

### 학습 목표

- 배열 예비 노트의 핵심 개념과 사용 목적을 설명할 수 있다.
...
- int, float, char 자료형 배열(string)/집합(set) ➝ 같은 자료형끼리 구성 가능

- 선언(메모리박스 할당)

자료형 변수명 \[배열의 크기 = 메모리박스 갯수\];

- 참고: 메모리박스 크기 기준 → 선언한 자료형의 크기
...
문자 '열' 출력 (`printf`함수 + `%s` ) 위해 Set-Up 필요

- 이유: `printf`함수 + `%s` ➝ '\\0' 전 문자까지 출력
...
---
<!-- LESSON-NAV:START -->
[이전: 07. 변수 유효범위](./07_변수_유효범위.md) · [단원 목차](./README.md) · [다음: 01. 기본 입출력](../02_입출력_및_연산자/01_기본_입출력.md)
<!-- LESSON-NAV:END -->

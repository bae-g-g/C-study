...
> 이전 학습: [02. 자료형 입출력](./02_자료형_입출력.md)  
> 다음 학습: [04. 문자 배열 입출력](./04_문자_배열_입출력.md)

<p align="center">
  <img src="./img/A1.png" alt="03. 배열 입출력 대표 이미지" width="720">
</p>

### 학습 목표

- 배열 입출력의 핵심 개념과 사용 목적을 설명할 수 있다.
...
- 참고: 70-80%: 선언시 메모리박스크기(배열크기) 만큼 자동 \\0=null Set-Up O

- 참고: 10-20%: 선언시 메모리박스 내 쓰레기값 생성

- 따라서 선언시 메모리박스크기(배열크기) 만큼 자동 \\0=null Set-Up X
...
- 참고: 배열크기 = 초기화 변수갯수 + 1개 이상 (\\0=null 문자 생성 공간)
...
---
<!-- LESSON-NAV:START -->
[이전: 02. 자료형 입출력](./02_자료형_입출력.md) · [단원 목차](./README.md) · [다음: 04. 문자 배열 입출력](./04_문자_배열_입출력.md)
<!-- LESSON-NAV:END -->

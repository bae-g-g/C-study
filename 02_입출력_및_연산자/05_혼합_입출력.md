...
> 이전 학습: [04. 문자 배열 입출력](./04_문자_배열_입출력.md)  
> 다음 학습: [15. 연산자 강의](./15_연산자_강의.md)

<p align="center">
  <img src="./img/ivc.png" alt="05. 혼합 입출력 대표 이미지" width="720">
</p>

### 학습 목표

- 혼합 입출력의 핵심 개념과 사용 목적을 설명할 수 있다.
- 예제 코드를 읽고 실행 흐름과 결과를 단계별로 추적할 수 있다.
- 이전 단원에서 배운 개념과 다음 단원에서 이어질 내용을 연결할 수 있다.

### 수업 흐름

1. int float char array
2. Input 입력
3. Output 출력
4. Summary 요약
...
- 참고: 8.625의 2진수 입력/저장 = 8.625의 부동소수점 환산 2진수 입력/저장
...
- 참고: printf 정수(%d) 자료형크기(4 Bytes)만큼 정수형태 출력 X
- → 2진수(Little Endian) 01011000 00000000 00000000 01100001 ≠ 10진수 88

### 쓰레기값

- 참고: 선언한 자료형크기(1 Byte)만큼 정수(%d) 1개 출력 O
...
---
<!-- LESSON-NAV:START -->
[이전: 04. 문자 배열 입출력](./04_문자_배열_입출력.md) · [단원 목차](./README.md) · [다음: 15. 연산자 강의](./15_연산자_강의.md)
<!-- LESSON-NAV:END -->

...
> 이전 학습: [15. 연산자 강의](./15_연산자_강의.md)  
> 다음 학습: [07. 관계 연산자](./07_관계_연산자.md)

<p align="center">
  <img src="./img/ar1.png" alt="06. 산술 대입 연산자 대표 이미지" width="720">
</p>

### 학습 목표

- 산술 대입 연산자의 핵심 개념과 사용 목적을 설명할 수 있다.
...
int main()
{
    ...
    printf("%d  %d  %d\n", ++B[1], ++B[1], ++B[1]);    // X방식(TEMP O: 각각초기화) ← 아래 Y 방식(TEMP 작동 X)
    // Window OS(L ← R):  X방식(TEMP O: 각각초기화)
    ...
    printf("%d  %d  %d  %d\n", C[1]++, ++C[1], C[1]++, ++C[1]); // 후위연산자: X방식(TEMP O: 각각초기화) + 전위연사자: X방식(TEMP O: 각각초기화) ← 아래 Y 방식(TEMP 작동 X)
    // Window OS(L ← R):  후위연산자: X방식(TEMP O: 각각초기화) + 전위연사자래 X방식(TEMP O: 각각초기화)
...
int main()
{
    ...
    printf("---Output B---\n");  
    printf("%d  %d  %d\n", ++B, ++B, ++B);          // X방식(TEMP O: 각각초기화) ← 아래 Y 방식(TEMP 작동 X)
    // Window OS(L ← R):  X방식(TEMP O: 각각초기화)
    ...
    printf("---Output C---\n");  
    printf("%d  %d  %d  %d\n", C++, ++C, C++, ++C); // 후위연산자: X방식(TEMP O: 각각초기화) + 전위연사자: X방식(TEMP O: 각각초기화) ← 아래 Y 방식(TEMP 작동 X)
...
---
<!-- LESSON-NAV:START -->
[이전: 15. 연산자 강의](./15_연산자_강의.md) · [단원 목차](./README.md) · [다음: 07. 관계 연산자](./07_관계_연산자.md)
<!-- LESSON-NAV:END -->

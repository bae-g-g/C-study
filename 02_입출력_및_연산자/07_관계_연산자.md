...
> 이전 학습: [06. 산술 대입 연산자](./06_산술_대입_연산자.md)  
> 다음 학습: [08. 논리 연산자](./08_논리_연산자.md)

<p align="center">
  <img src="./img/R.png" alt="07. 관계 연산자 대표 이미지" width="720">
</p>

### 학습 목표

- 관계 연산자의 핵심 개념과 사용 목적을 설명할 수 있다.
- 예제 코드를 읽고 실행 흐름과 결과를 단계별로 추적할 수 있다.
- 이전 단원에서 배운 개념과 다음 단원에서 이어질 내용을 연결할 수 있다.

### 수업 흐름

1. Relational Operator 관계 연산자
...
- 따라서 `scanf` 함수 1 Line 작성 권장 X (이유 1: OS 차이 → 출력 차이, 이유 2: 가시성 ↓)
...
TEMP O: '선' 생성된 TEMP와 '후' 생성된 TEMP는 Different Assembly Sector 내에 존재 → 침범 O
...
TEMP O: '선' 생성된 TEMP와 '후' 생성된 TEMP는 Same Assembly Sector 내에 존재 → 침범 X
...
---
<!-- LESSON-NAV:START -->
[이전: 06. 산술 대입 연산자](./06_산술_대입_연산자.md) · [단원 목차](./README.md) · [다음: 08. 논리 연산자](./08_논리_연산자.md)
<!-- LESSON-NAV:END -->

...
> 이전 학습: [14. 실수 이진 연산](./14_실수_이진_연산.md)  
> 다음 학습: [16. 조건문 강의](./16_조건문_강의.md)

<p align="center">
  <img src="./img/CA.png" alt="13. 컴퓨터 구조와 임시변수 대표 이미지" width="720">
</p>

### 학습 목표

- 컴퓨터 구조와 임시변수의 핵심 개념과 사용 목적을 설명할 수 있다.
- 예제 코드를 읽고 실행 흐름과 결과를 단계별로 추적할 수 있다.
- 이전 단원에서 배운 개념과 다음 단원에서 이어질 내용을 연결할 수 있다.

### 수업 흐름

1. Computer Architecture 컴퓨터구조
2. Assembly Language
...
---
<!-- LESSON-NAV:START -->
[이전: 14. 실수 이진 연산](./14_실수_이진_연산.md) · [단원 목차](./README.md) · [다음: 16. 조건문 강의](./16_조건문_강의.md)
<!-- LESSON-NAV:END -->

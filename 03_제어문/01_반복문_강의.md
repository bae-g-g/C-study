...
> 단원: [03. 제어문](./README.md)  
> 이전 학습: [16. 조건문 강의](../02_입출력_및_연산자/16_조건문_강의.md)  
> 다음 학습: [02. 분기문](./02_분기문.md)

### 학습 목표

- 반복문 강의의 핵심 개념과 사용 목적을 설명할 수 있다.
...
- 참고: do while 문 (조건/조건식) 뒤 ; Semicolon 작성
...
```c
if 중괄호 없음: if (조건/조건식) 1문장 Code**;** → 한 Code 문장
...
- 참고: Compiling ⑤: 초기화식 ① → 조건/조건식 ② → Code Block; ③ → 증감식 ④
...
| 예:<br>가습기 물 있음(조건식 = True) →가습기 반복 동작 O<br>가습기 물 없음(조건식 = False)→가습기 반복 동작 X | 예:<br>학생수만큼(조건식)→성적출력반복<br>메뉴수만큼(조건식)→가격출력반복 |
| 음상호변환                                                                                                    | 음                                                                        | ※ while → for 변환 가능 O<br>※ for → while 변환 가능 O (권장 X)<br>∵ 증감코드 차이점 참조 |
| 증감코드                                                                                                      |                                                                           | 반복문 1회 실행<br>→ 반드시 함께 1회 실행 X<br>(Code by Code)                             | 반복문 1회 실행<br>→ 반드시 함께 1회 실행 O |
| 조건식<br>코드블럭                                                                                            | 조건식 반복문 시작 <br>→ 조건확인 후 실행                                 | 조건식 반복문 끝 <br>→ 조건관계없이 1회 실행<br>(조건식=False도 실행)                     |                                             |
...
---
<!-- LESSON-NAV:START -->
[이전: 16. 조건문 강의](../02_입출력_및_연산자/16_조건문_강의.md) · [단원 목차](./README.md) · [다음: 02. 분기문](./02_분기문.md)
<!-- LESSON-NAV:END -->

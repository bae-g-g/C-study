...
> 단원: [03. 제어문](./README.md)  
> 이전 학습: [01. 반복문 강의](./01_반복문_강의.md)  
> 다음 학습: [01. 1차원 배열](../04_배열과_문자열/01_1차원_배열.md)

### 학습 목표

- 분기문의 핵심 개념과 사용 목적을 설명할 수 있다.
- 예제 코드를 읽고 실행 흐름과 결과를 단계별로 추적할 수 있다.
- 이전 단원에서 배운 개념과 다음 단원에서 이어질 내용을 연결할 수 있다.

### 수업 흐름

1. Jump Statement 점프문
...
---
<!-- LESSON-NAV:START -->
[이전: 01. 반복문 강의](./01_반복문_강의.md) · [단원 목차](./README.md) · [다음: 01. 1차원 배열](../04_배열과_문자열/01_1차원_배열.md)
<!-- LESSON-NAV:END -->

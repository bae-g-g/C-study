...
> 이전 학습: [01. 1차원 배열](./01_1차원_배열.md)  
> 다음 학습: [01. 함수 강의](../05_함수/01_함수_강의.md)

<p align="center">
  <img src="./img/J2.png" alt="02. 다차원 배열 대표 이미지" width="720">
</p>

### 학습 목표

- 다차원 배열의 핵심 개념과 사용 목적을 설명할 수 있다.
- 예제 코드를 읽고 실행 흐름과 결과를 단계별로 추적할 수 있다.
- 이전 단원에서 배운 개념과 다음 단원에서 이어질 내용을 연결할 수 있다.

### 수업 흐름

1. Multi-Dimensional Array 다차원 배열
2. Structure 구조
3. Address 주소값
...
---
<!-- LESSON-NAV:START -->
[이전: 01. 1차원 배열](./01_1차원_배열.md) · [단원 목차](./README.md) · [다음: 01. 함수 강의](../05_함수/01_함수_강의.md)
<!-- LESSON-NAV:END -->

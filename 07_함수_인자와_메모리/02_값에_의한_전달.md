...
> 이전 학습: [01. 함수 인자 기초](./01_함수_인자_기초.md)  
> 다음 학습: [03. 주소에 의한 전달 매개변수](./03_주소에_의한_전달_매개변수.md)

<p align="center">
  <img src="./img/CBV.png" alt="02. 값에 의한 전달 대표 이미지" width="720">
</p>

### 학습 목표

- 값에 의한 전달의 핵심 개념과 사용 목적을 설명할 수 있다.
...
---
<!-- LESSON-NAV:START -->
[이전: 01. 함수 인자 기초](./01_함수_인자_기초.md) · [단원 목차](./README.md) · [다음: 03. 주소에 의한 전달 매개변수](./03_주소에_의한_전달_매개변수.md)
<!-- LESSON-NAV:END -->

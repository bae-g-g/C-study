...
> 이전 학습: [04. 주소에 의한 전달 반환](./04_주소에_의한_전달_반환.md)  
> 다음 학습: [06. 참조에 의한 전달](./06_참조에_의한_전달.md)

<p align="center">
  <img src="./img/CBA.png" alt="05. 주소에 의한 전달 일반 대표 이미지" width="720">
</p>

### 학습 목표

- 주소에 의한 전달 일반의 핵심 개념과 사용 목적을 설명할 수 있다.
...
---
<!-- LESSON-NAV:START -->
[이전: 04. 주소에 의한 전달 반환](./04_주소에_의한_전달_반환.md) · [단원 목차](./README.md) · [다음: 06. 참조에 의한 전달](./06_참조에_의한_전달.md)
<!-- LESSON-NAV:END -->

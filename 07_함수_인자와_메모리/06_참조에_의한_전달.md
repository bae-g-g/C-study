...
> 이전 학습: [05. 주소에 의한 전달 일반](./05_주소에_의한_전달_일반.md)  
> 다음 학습: [07. 메모리 컴파일 런타임](./07_메모리_컴파일_런타임.md)

<p align="center">
  <img src="./img/F5.png" alt="06. 참조에 의한 전달 대표 이미지" width="720">
</p>

### 학습 목표

- 참조에 의한 전달의 핵심 개념과 사용 목적을 설명할 수 있다.
...
직접 참조하기 때문에 메인 함수의 변수값이 변경이 되어버림 O

- = 메인 함수의 Local Variable 지역 변수 값 보존 X
...
---
<!-- LESSON-NAV:START -->
[이전: 05. 주소에 의한 전달 일반](./05_주소에_의한_전달_일반.md) · [단원 목차](./README.md) · [다음: 07. 메모리 컴파일 런타임](./07_메모리_컴파일_런타임.md)
<!-- LESSON-NAV:END -->

...
> 이전 학습: [09. 배열 반환](./09_배열_반환.md)  
> 다음 학습: [01. 함수 포인터 기초](../08_함수_포인터와_고급/01_함수_포인터_기초.md)

<p align="center">
  <img src="./img/mms6.png" alt="10. 동적 메모리 반환 대표 이미지" width="720">
</p>

### 학습 목표

- 동적 메모리 반환의 핵심 개념과 사용 목적을 설명할 수 있다.
- 예제 코드를 읽고 실행 흐름과 결과를 단계별로 추적할 수 있다.
- 이전 단원에서 배운 개념과 다음 단원에서 이어질 내용을 연결할 수 있다.

### 수업 흐름

1. ② Return Dynamic Memory Allocation 동적 메모리 반환
2. Dynamic Memory Allocation Function 동적 메모리 할당 함수
...
- 참고: 동적 메모리 할당 함수 내부적으로 느슨한 PRIORTY QUEUE 방식 구현되어 있음
...
---
<!-- LESSON-NAV:START -->
[이전: 09. 배열 반환](./09_배열_반환.md) · [단원 목차](./README.md) · [다음: 01. 함수 포인터 기초](../08_함수_포인터와_고급/01_함수_포인터_기초.md)
<!-- LESSON-NAV:END -->

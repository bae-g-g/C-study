...
> 이전 학습: [10. 동적 메모리 반환](../07_함수_인자와_메모리/10_동적_메모리_반환.md)  
> 다음 학습: [02. 함수 포인터 활용1](./02_함수_포인터_활용1.md)

<p align="center">
  <img src="./img/F.png" alt="01. 함수 포인터 기초 대표 이미지" width="720">
</p>

### 학습 목표

- 함수 포인터 기초의 핵심 개념과 사용 목적을 설명할 수 있다.
- 예제 코드를 읽고 실행 흐름과 결과를 단계별로 추적할 수 있다.
- 이전 단원에서 배운 개념과 다음 단원에서 이어질 내용을 연결할 수 있다.

### 수업 흐름

1. Function Pointer Variable 함수 포인터 변수
2. Concept 개념
3. Concept #1
4. Concept #2
5. Usage 용도
6. Declaration & Initialisation 선언 및 초기화
...
4. 함수 실행 중 다른 함수 생성 (함수 포인터 변수를 함수 리턴값으로 사용)
...
---
<!-- LESSON-NAV:START -->
[이전: 10. 동적 메모리 반환](../07_함수_인자와_메모리/10_동적_메모리_반환.md) · [단원 목차](./README.md) · [다음: 02. 함수 포인터 활용1](./02_함수_포인터_활용1.md)
<!-- LESSON-NAV:END -->

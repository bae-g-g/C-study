...
> 이전 학습: [01. 비트 연산](./01_비트_연산.md)  
> 다음 학습: [03. 문자열 연산](./03_문자열_연산.md)

### 학습 목표

- 구조체와 공용체의 핵심 개념과 사용 목적을 설명할 수 있다.
- 예제 코드를 읽고 실행 흐름과 결과를 단계별로 추적할 수 있다.
- 이전 단원에서 배운 개념과 다음 단원에서 이어질 내용을 연결할 수 있다.

### 수업 흐름

1. 왜 고정된 메모리크기를 가진 정수를 사용하는가?
2. 레지스터 조작
3. 이식성,통신 프로토콜
4. 키워드
5. 의미
...
---
<!-- LESSON-NAV:START -->
[이전: 01. 비트 연산](./01_비트_연산.md) · [단원 목차](./README.md) · [다음: 03. 문자열 연산](./03_문자열_연산.md)
<!-- LESSON-NAV:END -->
